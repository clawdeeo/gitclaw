...
fn test_installed_package_struct() {
    ...
    assert_eq!(pkg.asset_name, "ripgrep-13.0.0-x86_64-unknown-linux-musl.tar.gz");
}
...
fn test_registry_remove() {
    ...
    registry.packages.insert("user1/pkg1".to_string(), gitclaw::registry::InstalledPackage {
    ...
    registry.packages.insert("user2/pkg2".to_string(), gitclaw::registry::InstalledPackage {
...
fn test_registry_is_installed() {
    ...
    registry.packages.insert("test/package".to_string(), gitclaw::registry::InstalledPackage {
        name: "test/package".to_string(),
        owner: "test".to_string(),
        repo: "package".to_string(),
        version: "1.0.0".to_string(),
...
fn test_serialize_deserialize() {
    let mut registry = gitclaw::registry::Registry::default();
    registry.packages.insert("test/pkg".to_string(), gitclaw::registry::InstalledPackage {
        name: "test/pkg".to_string(),
        owner: "test".to_string(),
        repo: "pkg".to_string(),
        version: "1.0.0".to_string(),
